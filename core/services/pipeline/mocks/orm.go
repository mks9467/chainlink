...
// CreateSpec provides a mock function with given fields: q, _a1, maxTaskTimeout
func (_m *ORM) CreateSpec(q postgres.Queryer, _a1 pipeline.Pipeline, maxTaskTimeout models.Interval) (int32, error) {
	ret := _m.Called(q, _a1, maxTaskTimeout)

	var r0 int32
	if rf, ok := ret.Get(0).(func(postgres.Queryer, pipeline.Pipeline, models.Interval) int32); ok {
		r0 = rf(q, _a1, maxTaskTimeout)
	} else {
		r0 = ret.Get(0).(int32)
	}

	var r1 error
	if rf, ok := ret.Get(1).(func(postgres.Queryer, pipeline.Pipeline, models.Interval) error); ok {
		r1 = rf(q, _a1, maxTaskTimeout)
	} else {
		r1 = ret.Error(1)
	}
